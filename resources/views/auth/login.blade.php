<x-guest-layout>
    ...
    <div class="flex flex-col md:flex-row min-h-screen w-full">
        ...
        <div class="w-full md:w-1/3 flex flex-col justify-center px-6 py-12 sm:px-10">
            ...
            <div class="w-full max-w-md mx-auto px-10">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4 ">
                    ...
                    <div class="flex items-center justify-end mt-4">
                     ...
                     <!-- Submit Button -->
                    <button type="submit"
                        class=" login-button w-full flex items-center justify-center gap-2 py-3  bg-green-600  text-white font-semibold rounded-full transition duration-300 ">
                        <span>Sign In</span>
            ...
            <p class="text-sm mt-4 text-center ">Dont have an Account? <span
