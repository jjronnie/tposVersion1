    <div x-show="activeTab === 'Business'" class="max-w-3xl mx-auto  rounded-lg shadow p-6 space-y-6">
                ...
                <div class="mt-1 flex items-center">
                    @if ($business->logo_path)
                        <img src="{{ asset('storage/' . $business->logo_path) }}"
                            class="h-20 w-20 rounded border mr-4 object-cover" />
                    @endif
                    <input type="file" name="logo" class="block text-sm " />
                </div>
            </div>

            <div class="pt-4">
                <button type="submit" class="btn">Save Changes <i data-lucide="save"
                        class="w-5 h-5 ml-2 text-white"></i></button>
            </div>
        </form>
