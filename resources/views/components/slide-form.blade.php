<div x-data="{ openForm: false }" class="relative">
    ...
    <div x-show="openForm" x-cloak
        ...
        class="fixed top-0 right-0 w-full sm:max-w-[70%] h-full bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-xl z-[9998] flex flex-col">
    ...
    <!-- Overlay -->
    <div x-show="openForm" x-cloak @click="openForm = false"
