...
<div class="fixed bottom-6 right-6 z-50" x-data="{ quickAccessOpen: false }" @click.away="quickAccessOpen = false">
    ...
    <!-- Floating Button -->
    <button 
        class="w-14 h-14 flex items-center justify-center rounded-full bg-blue-600 text-white shadow-lg hover:bg-blue-700 transition"
    ...
    <div 
        ...
        x-transition 
        x-cloak
        class="absolute bottom-16 right-0 w-64 bg-white rounded-lg shadow-lg border border-gray-200">

        <div class="p-4">
            <h3 class="text-sm font-medium text-gray-900 mb-3">Quick Access</h3>
            <div class="space-y-2 max-h-80 overflow-y-auto">
                <a href="#" class="flex items-center space-x-3 px-3 py-2 rounded-md hover:bg-gray-50 text-gray-700">
